...
// $_COOKIE["page"]= "edit_profile";
  ...
  ?>
  <form name="RegForm" action="update_profile.php" onsubmit="return REG_FORM()" method="post" enctype="multipart/form-data">
	<div>
...
?>
                        ...
                        <tr>
                            <td></td>
                            <td align="left">
                                <a href="user_profile.php"><button type="button" class="btn btn-secondary">close</button></a>&nbsp&nbsp
 <button type="submit" name="update" value="update" class="btn btn-primary">Save</button>&nbsp&nbsp                             
                            </td>
                        </tr>
