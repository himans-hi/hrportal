         ...
         $query1 = "select * from students where fname='$a'and password='$b' limit 1";
           ...
           if($row > 0) 
            ...
            //if($_REQUEST['username'] == 'admin' && $_REQUEST['password'] == 'admin123'){
				...
				{
            echo COOKIE_USER . $username;
            echo COOKIE_PASS .$password;
			setcookie(COOKIE_USER,$a,time()+60*60*7);
			setcookie(COOKIE_PASS,$b,time()+60*60*7);
			setcookie("type",setuser,time()+60*60*7);
			...
			if($row["username"]=="newuser" && $row["password"]=="spice@123")
			{
            echo COOKIE_USER . $username;
            echo COOKIE_PASS .$password;
			setcookie(COOKIE_USER,$a,time()+60*60*7);
			...
			if($row["username"]=="hr" && $row["password"]=="hr123")
			{
            echo COOKIE_USER . $username;
            echo COOKIE_PASS .$password;
			setcookie(COOKIE_USER,$a,time()+60*60*7);
			...
			if($row["username"]=="hod" && $row["password"]=="hod123")
			{
            echo COOKIE_USER . $username;
            echo COOKIE_PASS .$password;
			setcookie(COOKIE_USER,$a,time()+60*60*7);
