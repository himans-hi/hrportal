...
class SMTP
{
    ...
    protected function edebug($str, $level = 0)
    {
        ...
        if (!in_array($this->Debugoutput, array('error_log', 'html', 'echo1')) and is_callable($this->Debugoutput)) {
     ...
     */
    public function setDebugOutput($method = 'echo1')
    {
